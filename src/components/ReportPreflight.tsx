 ...
 *
 * ⚠️ THREE, and only three. Anwesenheit and Material were tried as two more tabs here
...
// the whole options object: the seeds `kroki` / `atemschutz` follow the LIVE
...
export function ReportPreflight({
  incident, reportMeta, personnel = [], presentIds = NO_IDS, onRolePicked, onAddGuest, events, annotatedPlanCount, truppCount, attendanceCount, mittelCount, mittel = [], mapContentCount = 1, pendingMediaCount = 0, attendance = {}, trupps = [], contactIntervalMin, contactGraceSec, plans = [], scene, board, building, suche, sucheStack, captureUsage, canEdit = true, canShare = canEdit, attachments = [], onAddAttachments, onCaptionAttachment, onRemoveAttachment, onSaveMeta, onEditDispatch, onOpenAnwesenheit, onOpenMittel, onResolveConflict, onComplete, onFixTranscripts,
}: {
            ...
            {((!checking && !controlOk) || openInControl) && (
              ...
              >
                ...
                <div className="report-fold-body">
                  ...
                  <p><Icon id="doc" /> {options.allPlans ? P.plansPrintAll : options.annotatedPlans ? fillTemplate(P.plansPrintAnnotated, { n: annotatedPlanCount }) : P.plansPrintNone}</p>
