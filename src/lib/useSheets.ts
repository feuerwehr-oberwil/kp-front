...
export function useSheets() {
  ...
  /** «Teilen» — the share sheet + QR. Not a boolean: which of the two links the sheet OPENS on
   *  is part of the door that opened it. «Teilen» in the Einsatzkopf and on the Einsatz-Karte
   *  means «Ganzer Einsatz» ('view'), the QR beside the Atemschutz bell means «Nur Atemschutz»
   *  ('atemschutz') — standing on the Tafel, that is the only thing it could have meant. The
   *  sheet's own tabs can still switch; `null` is closed. */
