...
export interface Prefs {
  ...
  /** which reading of the Anwesenheit surface was open last — the list or the Zeitplan. A reload
   *  mid-incident must come back to the tab you were working in. */
  anwesenheitView?: 'list' | 'plan'
