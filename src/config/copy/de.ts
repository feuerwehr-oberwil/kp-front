...
export const de = {
  ...
  suche: {
    ...
    rail: 'Suche',
    toolOpen: 'Suche einblenden',
    toolClose: 'Suche ausblenden',
    ...
    // Zustände
    status: { vermisst: 'vermisst', gefunden: 'gefunden', uebergeben: 'übergeben', entwarnt: 'entwarnt' },
    ...
    rausAsk: '{trupp}: {bereich} abgesucht?',
    rausAskHint: 'Die Antwort steht in der Suche und im Verlauf.',
    rausJa: 'Ja',
    ...
    rowFundPerson: 'Fund: {bereich} · {name}',
  ...
  admin: {
    ...
    setup: {
      ...
      sharepointSet: 'Zugang und Ordner hinterlegt – der Abgleich läuft',
      sharepointOpen: 'Zugangsdaten oder Ordner fehlen – ohne beides holt diese Instanz nichts aus SharePoint',
    },
    backup: {
      title: 'Sicherung',
    ...
    fleet: {
      ...
      controlGlossary: {
        ...
        count: 'Mehrere gleichartige Elemente werden als Anzahl geführt.', floor: 'Das Symbol kann einem Geschoss zugeordnet werden.',
        floorRange: 'Das Symbol kann einen Bereich von Geschossen abdecken.', spread: 'Richtung und Ausmass einer Ausbreitung können dargestellt werden.',
    ...
    modules: {
      ...
      alignmentCol: 'Karte',
      alignmentAuto: 'automatisch',
      alignmentManual: 'von Hand',
      alignmentHint: 'Wie Blätter dieses Moduls auf die Karte kommen: «automatisch» – der Server rechnet einen Vorschlag, den du unter Plan-Ausrichtung freigibst (im Einsatz gibt es dafür «Automatisch ausrichten»); «von Hand» – nur mit Referenzpunkten; «—» – nie auf der Karte. Gesetzt wird das in der Konfiguration (modules[].alignment).',
    ...
    // ── Plan-Ausrichtung: serverseitig vorbereitete Passungen prüfen und freigeben ──
    // Der Server rechnet je Objektblatt einen Vorschlag voraus (plan_alignment_worker); im
    ...
    alignment: {
      ...
      reasons: {
        ...
        georef_dependencies_missing: 'Die Bilderkennung ist auf diesem Server nicht installiert.',
        overpass_unconfigured: 'Kein Kartendaten-Spiegel (Overpass) konfiguriert.',
        ...
        manual_module: 'Für dieses Modul ist die Ausrichtung von Hand vorgesehen (Konfiguration: modules[].alignment).',
      ...
      grid: {
        ...
        decided: 'Entschieden',
        apply: 'Übernehmen ({n})',
        applySummary: '{yes} freigeben · {no} von Hand',
    ...
    system: {
      ...
      spTestFailed: 'Verbindungstest fehlgeschlagen',
      spSecretMissing: 'kein Ablaufdatum hinterlegt',
      spArea: 'Bereich',
