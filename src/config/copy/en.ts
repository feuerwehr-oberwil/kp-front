...
export const en: Localizable<Copy> = {
  ...
  atemschutz: {
    ...
    rueckzugNote: 'Turn-back pressure {bar} bar reached',
    rueckzugNoteEst: 'Turn-back pressure {bar} bar – reached per estimate',
    mindestNote: 'Below minimum pressure {bar} bar',
    mindestNoteEst: 'Below minimum pressure {bar} bar – per estimate',
    lineField: 'Line',
    edit: 'Edit',
  ...
  anwesenheit: {
    ...
    von: 'from',
    bis: 'to',
    addBlock: 'Another block',
    blockSplit: '{name}: new block – the running one was closed',
    blockRemoved: 'Block of {name} removed',
    blockRemove: 'Remove block',
    blocksTitle: 'Attendance – {name}',
    blocksSection: 'Recorded blocks',
    blocksNone: 'Has not been present yet.',
    blocksHint: 'Each block is one real turn on site. Correct a time here when a stamp landed wrong.',
  ...
  admin: {
    ...
    doctrine: {
      ...
      rueckzugBar: 'Turn-back pressure (bar)',
      rueckzugBarTip: 'Pressure at which the team turns back; the team card warns amber from here – including when only the estimate has reached it.',
