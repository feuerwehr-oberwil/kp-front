...
export const en: Localizable<Copy> = {
  ...
  notes: {
    ...
    boxLines: '{kind} · {n} lines',
    boxOneLine: '{kind} · 1 line',
    toLineConfirm: 'The note becomes a single line again. Line breaks will be lost.',
  },
  whiteboard: {
  ...
  zeitplan: {
    ...
    printConfirmTitle: 'Send Zeitplan to the station printer?',
    printConfirmMsg: 'The sheet goes to the station printer with {n} people on it.',
    pdf: 'As PDF',
    paperMenu: 'To paper',
