...
export const en: Localizable<Copy> = {
  ...
  zeitplan: {
    ...
    now: 'now',
    coverage: 'Cover',
    coverageHint: 'Scheduled above, actually present below – the gap shows where nobody is assigned.',
    planned: 'scheduled',
    actual: 'present',
    ...
    legendHint: 'Outline = scheduled · filled = actually present',
    ...
    plannedSection: 'Scheduled availability',
    ...
    laneHint: 'Drag to plan a shift · tap a bar to set it · drag to move · press and hold for all shifts',
    confirmed: 'set',
    tentative: 'planned',
    toggleHint: 'Tap: {state}',
