...
// The German strings mirror src/config/copy/de.ts (the default de-CH deployment locale).
...
export async function expectNoCrash(page: Page, where: string) {
  await expect(
...
export async function ensureIncidentOpen(page: Page) {
