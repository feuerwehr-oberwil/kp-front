...
- **One object, two surfaces — there are no twins any more** (10.09.2026,
  ...
  - ⚠️ **A MACHINE write never flips an anchor.** Only a hand places something. The live-GPS pass
    ...
    it. The act writes its own Verlauf row, «Geschoss 3. OG entfernt» (25.09.2026 — before, only its
    undo ever wrote one), and its ✕ is a --tap square in the tile's corner opposite the name and
    the fold eye. And the seam honours it per object: a lent anno
